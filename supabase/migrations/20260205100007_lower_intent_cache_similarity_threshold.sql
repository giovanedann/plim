-- Lower default similarity threshold from 0.92 to 0.85
-- 0.92 was too conservative for Portuguese colloquial variations (inverted word order, informal phrasing)
-- 0.85 catches natural rephrasings while avoiding cross-function false positives
