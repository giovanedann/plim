-- Migration: Encrypt expense description field
-- Adds encryption for the description column using the existing pgcrypto setup

-- ================================================================
-- STEP 1: Add encrypted description column to base table
-- ================================================================
ALTER TABLE private.expense_data
  ADD COLUMN description_encrypted BYTEA;

COMMENT ON COLUMN private.expense_data.description_encrypted IS 'PGP symmetric encrypted expense description';

-- ================================================================
-- STEP 2: Backfill existing descriptions with encrypted values
-- ================================================================
UPDATE private.expense_data
SET description_encrypted = pgp_sym_encrypt(
  description,
...
-- ================================================================
-- STEP 3: Update the expense view to decrypt description
-- ================================================================
...
SELECT
  ...
  user_id,
  category_id,
  -- Decrypt description (fall back to plain text if encrypted is NULL)
  CASE
...
-- ================================================================
-- STEP 4: Recreate INSERT trigger with description encryption
-- ================================================================
...
-- ================================================================
-- STEP 5: Recreate UPDATE trigger with description encryption
-- ================================================================
...
-- ================================================================
-- STEP 6: Recreate triggers (DROP + CREATE to ensure clean state)
-- ================================================================
...
COMMENT ON VIEW public.expense IS 'Transparent decrypting view for expenses. Both amount_cents and description are automatically decrypted.';
