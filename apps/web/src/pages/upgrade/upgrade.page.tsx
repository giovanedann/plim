...
import { AlertTriangle, CreditCard, Crown, QrCode } from 'lucide-react'
...
export function UpgradePage() {
  ...
  async function handleCardSubscription(): Promise<void> {
    setIsCreatingCard(true)
    const response = await paymentService.createCardSubscription()
  ...
  async function handleCancel(): Promise<void> {
    ...
    toast.success('Assinatura cancelada. Voce mantera o Pro ate o fim do periodo.')
  ...
  if (isLoading) {
    return (
      <div className="flex flex-1 flex-col gap-4 py-4 md:gap-6 md:py-6">
        ...
        <div className="mx-auto grid max-w-3xl gap-6 px-4 md:grid-cols-2 lg:px-6">
            ...
            <CardHeader>
              ...
              <CardDescription>
                {subscription?.payment_method === 'pix'
                  ? `Ativo ate ${subscription.current_period_end ? new Date(subscription.current_period_end).toLocaleDateString('pt-BR') : '-'}`
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Renovacao automatica mensal</CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-4">
                <div>
                  <p className="text-3xl font-bold">R$ 24,90</p>
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {isCreatingCard ? 'Redirecionando...' : 'Assinar com Cartao'}
                </Button>
              </CardContent>
            </Card>
          </div>
