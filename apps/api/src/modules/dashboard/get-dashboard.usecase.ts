import type { DashboardData, ExpensesTimelineQuery, TimelineGroupBy } from '@plim/shared'
...
export class GetDashboardUseCase {
  ...
  async execute(userId: string, query: GetDashboardQuery): Promise<DashboardData> {
